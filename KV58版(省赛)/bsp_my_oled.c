 ...
 *
 *@ param   uint8_t uc_posx  显示的横坐标0~122
 * 	    uint8_t uc_posy  页范围0～7
 *    	    uint8_t uc_data  显示的字符
 ...
 *  @ param   uint8_t uc_posx  显示的横坐标0~122
 *    		  uint8_t uc_posy  页范围0～7
 *    		  int8_t  c_data   需要转化显示的数值 -128~127
 *
