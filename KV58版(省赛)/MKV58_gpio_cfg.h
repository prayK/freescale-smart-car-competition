#ifndef __MKV58_GPIO_CFG_H__
#define __MKV58_GPIO_CFG_H__

/* GPIO - Peripheral instance base addresses */
/** Peripheral PTA base pointer */
#define PTA_BASE_PTR                             ((GPIO_Type *)0x400FF000u)
/** Peripheral PTB base pointer */
#define PTB_BASE_PTR                             ((GPIO_Type *)0x400FF040u)
/** Peripheral PTC base pointer */
#define PTC_BASE_PTR                             ((GPIO_Type *)0x400FF080u)
/** Peripheral PTD base pointer */
#define PTD_BASE_PTR                             ((GPIO_Type *)0x400FF0C0u)
/** Peripheral PTE base pointer */
#define PTE_BASE_PTR                             ((GPIO_Type *)0x400FF100u)
  
#define PT(X,n,REG)         BITBAND_REGADDR(PT##X##_BASE_PTR->##REG,n)              //位操作
