...
int ov7725_set_image_size(ov7725_size size)
{
    ...
    { 
        case H_60_W_80: 
            h_ov7725.h_size = 80;
            h_ov7725.v_size = 60;
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_HOutSize, 0x14);//宽度80
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_VOutSize, 0x1E);//高度60
            break; 
        case H_120_W_160:
            h_ov7725.h_size = 160;
            h_ov7725.v_size = 120;
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_HOutSize, 0x28);//宽度160
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_VOutSize, 0x3C);//高度120
            break; 
        case H_180_W_240: 
            h_ov7725.h_size = 240;  
            h_ov7725.v_size = 180; 
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_HOutSize, 0x3C);//宽度240
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_VOutSize, 0x5A);//高度180
            break;
        case H_240_W_320:
            h_ov7725.h_size = 320;
            h_ov7725.v_size = 240;
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_HOutSize, 0x50);//宽度320
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_VOutSize, 0x78);//高度240
            break;
        case H_240_W_80:
            h_ov7725.h_size = 80; //宽度80
            h_ov7725.v_size = 240;//高度240
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_HOutSize, 0x14);//宽度80
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_VOutSize, 0x78);//高度240
            break;
        case H_180_W_80:
            h_ov7725.h_size = 80; //宽度80
            h_ov7725.v_size = 180;//高度180
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_HOutSize, 0x14);//宽度80
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_VOutSize, 0x5A);//高度180
            break;
        case H_120_W_80:
            h_ov7725.h_size = 80; //宽度80
            h_ov7725.v_size = 120;//高度120
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_HOutSize, 0x14);//宽度80
            SCCB_WriteSingleRegister(h_ov7725.i2c_instance, h_ov7725.addr, OV7725_VOutSize, 0x3C);//高度120
            break;
        default: 
