...
//      模块通道    端口          可选范围                          建议
#define UART0_RX_PIN    PTA1        //PTA1、PTA15、PTB16、PTD6          PTA1不要用（与Jtag冲突）
#define UART0_TX_PIN    PTA2        //PTA2、PTA14、PTB17、PTD7          PTA2不要用（与Jtag冲突）
...
#define FTM0_CH2_PIN    PTA5        //PTC3、PTA5//电机
#define FTM0_CH3_PIN    PTA6        //PTC4、PTA6//电机
...
//      模块通道    端口          可选范围              建议
#define FTM1_CH0_PIN    PTA12       //PTA8、PTA12、PTB0 //编码器B相
#define FTM1_CH1_PIN    PTA13       //PTA9、PTA13、PTB1 //编码器A相

//      模块通道    端口          可选范围              建议
#define FTM2_CH0_PIN    PTA10       //PTA10、PTB18
#define FTM2_CH1_PIN    PTA11       //PTA11、PTB19

#define FTM3_CH0_PIN    PTE5        //PTE5      PTD0//舵机
