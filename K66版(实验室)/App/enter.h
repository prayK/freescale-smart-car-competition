...
typedef struct
{
    ...
    //TPM  脉冲计数
    void *      tpm_pulse_init;
//void tpm_pulse_init (TPMn_e tpmn, TPM_CLKIN_e clkin, TPM_PS_e ps, PTXn_e pin); //脉冲计数初始化
    ...
    //LCD 显示
    void *      lcd_init;        
    //void      lcd_init            (lcd_t * lcd,uint16_t rgb565);

    void *      lcd_point;        
    //void      lcd_point           (lcd_t * lcd,Site_t, uint16_t rgb565); //画点
    void *      lcd_points; 
    //void      lcd_points (lcd_t * lcd,Site_t *site,  uint32_t point_num, uint16_t rgb565); //画一堆点

    void *      lcd_rectangle;  
//void lcd_rectangle (lcd_t * lcd,Site_t,Size_t, uint16_t rgb565); //画矩形
    void *      lcd_cross;  
    //void      lcd_cross (lcd_t * lcd,Site_t,uint16_t len, uint16_t rgb565); //画十字形
    void *      lcd_clear;  
    //void      lcd_clear (lcd_t * lcd,uint16_t rgb565); //清屏
    ...
    void *      lcd_str_8x16;
//void lcd_str_8x16 (lcd_t * lcd,Site_t site, uint8 *Str,  uint16_t Color, uint16_t bkColor); //显示英文字符串
...
#define lcd_points(...)                           ENTER_FUN_ADDR(lcd_points,glcd,##__VA_ARGS__)
