...
extern void    LCD_ST7735S_init(Size_t *size);
extern void    LCD_ST7735S_dir(uint8 option);
extern void    LCD_ST7735S_ptlon(Site_t site, Size_t size);
extern void    LCD_ST7735S_ramwr(void);
extern void    LCD_ST7735S_wr_data_t(uint16_t data);
...
lcd_t   lcd_st7735s ={
    .lcd_w  =  ST7735S_W,
    .lcd_h  =  ST7735S_H,
    .init   =  LCD_ST7735S_init,
    .ptlon  =  LCD_ST7735S_ptlon,
    .ramwr  =  LCD_ST7735S_ramwr,
    .wr_data=  LCD_ST7735S_wr_data_t
...
//LCD_ST7735S初始化
extern void LCD_ST7735S_org_init() ;

void LCD_ST7735S_init(Size_t *size)
{
    LCD_ST7735S_org_init() ;
...
void LCD_ST7735S_ramwr(void)
{
    LCD_ST7735S_WR_8CMD(0x2C);
}
void LCD_ST7735S_wr_data_t(uint16_t data)
{

    LCD_ST7735S_WR_8DATA((uint8)((data)>>8) );
    LCD_ST7735S_WR_8DATA( (uint8)(data)) ;
}
/*!
