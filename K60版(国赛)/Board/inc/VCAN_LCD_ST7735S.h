...
/********************* ST7735S内部实现 ***********************/
//LCD 的管脚定义
#define     LCD_ST7735S_WR      PTB11//PTD6
#define     LCD_ST7735S_RD      PTC0//PTD10
#define     LCD_ST7735S_CS      PTB9//PTD2
#define     LCD_ST7735S_RS      PTB17//PTD8
#define     LCD_ST7735S_RST     PTB8//PTD4


//此部分需要修改初始化里的代码
#define     LCD_ST7735S_P0              PTB_B0_OUT
#define     LCD_ST7735S_PIN             PTB_B0_IN
#define     LCD_ST7735S_PDDR_OUT()      (DDRB_B0 = 0xff)
#define     LCD_ST7735S_PDDR_IN()       (DDRB_B0 = 0)
