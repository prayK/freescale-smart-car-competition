...
#define BRED    0XF81F
#define GRED    0X8430    //灰色
#define GBLUE   0X07FF    //
#define BLACK   0X0000    //黑色
#define WHITE   0XFFFF    //白色
#define YELLOW  0xFFE0    //黄色

#define FCOLOUR         BLACK    //定义字体颜色
#define BCOLOUR         BLUE     //定义背景颜色
...
extern void LCD_Img_gray_Z     (Site_t site, Size_t size, void *img, Size_t imgsize);   //显示灰度图像(可缩放)
